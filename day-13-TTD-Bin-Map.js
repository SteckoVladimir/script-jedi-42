...
// 4)  initialize http://tddbin.com/#?kata=es6/language/map/initialize
...
describe('initialize a `Map`', function(){
  ...
  it('keys are unique, the last one is used', function() {
    ...
    const pair3 = [1, 'eins'];
    const pair4 = [2, 'two'];
    const map = new Map([pair3, pair1, pair3, pair4]);
...
// 5)  map.has() http://tddbin.com/#?kata=es6/language/map/has
