// 1)   basics http://tddbin.com/#?kata=es6/language/symbol/basics
...
//  2)  Symbol.for() http://tddbin.com/#?kata=es6/language/symbol/for
...
//  3)   Symbol.keyFor() http://tddbin.com/#?kata=es6/language/symbol/keyFor
...
describe('`Symbol.keyFor()` gets the symbol key for a given symbol', function() {
  ...
  it('local symbols are not in the runtime-wide registry', function() {
    ...
    const localSymbol = Symbol(void 0);
  ...
  it('predefined symbols are not in the runtime-wide registry either', function() {
    const key = Symbol.keyFor(Symbol(void 0));
    assert.equal(key, void 0);
  });
